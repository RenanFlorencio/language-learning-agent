...
prompt = ChatPromptTemplate.from_messages([
    ("system", """
        ...
        You will use the information in the State object to determine which agent to call and with what parameters.
        You should never ask the user for information that you can get from the State object.
        Always use the information in the State object to determine which agents to call and with what parameters.
        ...
        - "rerank_only": user wants to rerank existing results
        ...
        After identifying the intent, you should call the appropriate agent(s) to fulfill the user's request.
